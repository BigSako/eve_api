...
*/
	...
	case 'orderCart2':
		...
		addTelegramNotificationForUserId($GLOBALS['user_id'], 
			"Your SM3LL shop order with ID $order_id has been stored. One of our logistics people will process your order as soon as possible!");

		addFleetbotPingForGroup("BC/MOVEITMOVEIT", "A new order (id: $order_id) has been created in the SM3LL Shop.");
